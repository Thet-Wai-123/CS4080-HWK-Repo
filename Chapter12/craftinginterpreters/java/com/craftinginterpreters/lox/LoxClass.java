...
class LoxClass extends LoxInstance implements LoxCallable {
  ...
  // Constructor specifically for metaclasses - no infinite recursion
  ...
  // Static factory method for creating metaclasses
  private static LoxClass createMetaclass(String name, Map<String, LoxFunction> classMethods) {
    return new LoxClass(name, classMethods);
  }

  // > Inheritance lox-class-constructor
  LoxClass(String name, LoxClass superclass,
      Map<String, LoxFunction> methods, Map<String, LoxFunction> classMethods) {
    this(name, superclass, methods, new HashMap<>(), classMethods);
  }

  LoxClass(String name, LoxClass superclass,
      Map<String, LoxFunction> methods, Map<String, LoxFunction> getters,
      Map<String, LoxFunction> classMethods) {
    super(createMetaclass(name + " metaclass", classMethods));
    this.superclass = superclass;
    // < Inheritance lox-class-constructor
    this.name = name;
    this.methods = methods;
