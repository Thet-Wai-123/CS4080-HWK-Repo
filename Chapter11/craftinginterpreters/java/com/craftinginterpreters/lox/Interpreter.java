...
//> Statements and State visit-var
  ...
  private void define(Token name, Object value) {
    if (environment != globals) {
      environment.define(value);  // Array-based for local variables
    } else {
      environment.define(name.lexeme, value);  // Map-based for global variables
    }
  }
//< Statements and State visit-var
...
//> super-find-this
    ...
    LoxInstance object = (LoxInstance)environment.getAt(
        distance - 1, 0);  // "this" is always at index 0
//< super-find-this
//> super-find-method
