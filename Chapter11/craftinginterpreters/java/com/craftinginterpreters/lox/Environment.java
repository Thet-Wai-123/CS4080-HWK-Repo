...
class Environment {
  ...
  private final List<Object> slots = new ArrayList<>(); // Array-based storage for local variables
...
//> environment-define
  ...
  // Define a variable in the array-based storage (for local variables)
...
//> Resolving and Binding get-at
  ...
  // Indexed getAt for array-based local variables
...
//> Resolving and Binding assign-at
  ...
  // Indexed assignAt for array-based local variables
